...
% Gname2='F:/COAWST_DATA/Yaeyama/Yaeyama2/Grid/Yaeyama2_grd_v11.2.nc';
% Gname3='F:/COAWST_DATA/Yaeyama/Yaeyama3/Grid/Yaeyama3_grd_v12.2.nc';
Gname1='F:/COAWST_DATA/TokyoBay/TokyoBay2/Grid/TokyoBay2_grd_v2.1.nc';
Gname2='F:/COAWST_DATA/TokyoBay/TokyoBay3/Grid/TokyoBay3_grd_v2.1.nc';

% Cname='Berau_ngc_2g_CTB1_v1.0.nc';  %% for single nesting
% Cname='Fukido_ngc_2g_F2F3_v5.0.nc';  %% for single nesting
% Cname='Yaeyama_ngc_2g_Y1Y2_v1.3.nc';  %% for single nesting
% Cname='Yaeyama_ngc_2g_Y2Y3_v1.0.nc';  %% for single nesting
% Cname='Yaeyama_ngc_3g_Y1Y2Y3_v1.0.nc';  %% for single nesting
Cname='TokyoBay_ngc_2g_T2T3_v4.0.nc';  %% for single nesting
