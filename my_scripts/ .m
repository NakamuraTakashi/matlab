function[h_surf,h_contour,axes1,h_annot,h_annot2]= createfigure5(XData1,YData1,CData1,zdata2, annot_str, title1,Cmin,Cmax, colmap, xsize,ysize,xmin,xmax,ymin,ymax,unit,LevelList)
...
axes1 = axes('Parent',figure1,...
    ...
    'FontName','Arial',...
    'CLim',[Cmin Cmax],...
    'Position',[30/xsize (90+5)/ysize plotwidth plotheight],...
    'Box','on');
% Axes
%xlim(axes1,[-25 3125]);
...
annotation(figure1,'textbox',...
    [0.0 (705-135+5)/ysize 1.0 26.25/ysize],...
...
lgd=legend(legend_dummy_plot,labels,'Position',[185/xsize (90+37.5+5)/ysize 12/xsize 35/ysize]);
...
h_annot=annotation(figure1,'textbox',...
    [0.0 33.75/ysize 1.0 26.25/ysize],...
    'HorizontalAlignment', 'center',...
    'String',annot_str,...
    'FontName','Arial',...
    'FontSize',11,...
