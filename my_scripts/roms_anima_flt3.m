...
elseif id == 2
%     [h_scatter,h_contour,h_annot]=createfltplot4(x_rho,y_rho,xfloat(:,i),yfloat(:,i),cfloat(:,i),h,date_str,'Larvae',-1,40,flipud(winter(256)),xsize,ysize,xmin,xmax,ymin,ymax);
    [h_scatter,h_contour,h_annot]=createfltplot4(x_rho,y_rho,xfloat,yfloat,cfloat,h,date_str,'Larvae (depth/m)',-2,32,flipud(jet(128)),xsize,ysize,xmin,xmax,ymin,ymax);
elseif id == 3
    [h_scatter,h_contour,h_annot]=createfltplot4(x_rho,y_rho,xfloat,yfloat,cfloat,h,date_str,'Larvae (temperature)',26,33,jet(128),xsize,ysize,xmin,xmax,ymin,ymax);
elseif id == 4
    [h_scatter,h_contour,h_annot]=createfltplot4(x_rho,y_rho,xfloat,yfloat,cfloat,h,date_str,'Larvae (salinity)',30,36,jet(128),xsize,ysize,xmin,xmax,ymin,ymax);
elseif id == 5
    [h_scatter,h_contour,h_annot]=createfltplot4(x_rho,y_rho,xfloat,yfloat,cfloat,h,date_str,'Larvae (phytoplankton1)',0,2,jet(128),xsize,ysize,xmin,xmax,ymin,ymax);
elseif id == 6
    [h_scatter,h_contour,h_annot]=createfltplot4(x_rho,y_rho,xfloat,yfloat,cfloat,h,date_str,'Larvae (individuals/particle)',0,1.0e7,colmap1,xsize,ysize,xmin,xmax,ymin,ymax);
elseif id == 7
    [h_scatter,h_contour,h_annot]=createfltplot4(x_rho,y_rho,xfloat,yfloat,cfloat,h,date_str,'Larvae (phytoplankton)',0,5,jet(128),xsize,ysize,xmin,xmax,ymin,ymax);
elseif id == 8
    [h_scatter,h_contour,h_annot]=createfltplot4(x_rho,y_rho,xfloat,yfloat,cfloat,h,date_str,'Larvae (lipid)',0,1,jet(128),xsize,ysize,xmin,xmax,ymin,ymax);
elseif id == 9
    [h_scatter,h_contour,h_annot]=createfltplot4(x_rho,y_rho,xfloat,yfloat,cfloat,h,date_str,'Larvae (mortality)',0,5,jet(128),xsize,ysize,xmin,xmax,ymin,ymax);
elseif id == 10
    [h_scatter,h_contour,h_annot]=createfltplot4(x_rho,y_rho,xfloat,yfloat,cfloat,h,date_str,'Larvae (age)',0,14,jet(14),xsize,ysize,xmin,xmax,ymin,ymax);
elseif id == 11
    [h_scatter,h_contour,h_annot]=createfltplot4(x_rho,y_rho,xfloat,yfloat,cfloat,h,date_str,'Larvae (status)',-0.5,4.5,jet(5),xsize,ysize,xmin,xmax,ymin,ymax);
elseif id == 12
    xSet(1)=NaN;
    ySet(1)=NaN;
    cSet(1)=NaN;
    [h_scatter,h_scatter2,h_contour,h_annot]=createfltplot3(x_rho,y_rho,xfloat,yfloat,cfloat,xSet,ySet,cSet,h,date_str,'Larvae (individuals/particle)',0,1.0e6,colmap4,xsize,ysize,xmin,xmax,ymin,ymax);
...
for i=36:1:imax%336 %imax-1  %i=1:imax-1
    ...
    elseif id == 13
        ...
        xfloat(period>24)=NaN;
        yfloat(period>24)=NaN;
        cfloat = ifloat;
    end
