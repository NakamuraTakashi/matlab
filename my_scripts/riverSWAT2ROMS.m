...
RIVER_FILES = {'./data/Nakama_Flow_2013-2014.txt';
               './data/Nagura_Flow_2013-2014.txt';
               './data/Arakawa_Flow_2013-2014.txt';
               './data/Miyara_Flow_2013-2014.txt';
               './data/Todoroki_Flow_2013-2014.txt'
               };
           
date_start = '2000/1/1';
LOCAL_TIME = 9; % hours: UTC+9 (JST) 

riv_D = [  0,   0,   0,   1,   0 ];  % east<->west:0,  south<->north:1
riv_D2= [  1,  -1,  -1,  -1,   1 ];  % east->west or south-> north: 1,  west->east or north-> south:-1
...
% % Yaeyama2 grid
% NC_FILE = 'D:/ROMS/Yaeyama/Data/Yaeyama2_river_Nz15_13_14.nc';
% xi_u = 301 ;
% eta_v = 301 ;
% s_rho = 15 ;
% river = 5 ;
% riv_X = [ 94, 182, 183, 206, 219 ];
% riv_Y = [116, 162, 142, 145, 155 ];
...
for i=1:river
     riv(i) = tdfread(RIVER_FILES{i});
end

river_time = size(riv(1).Date,1) ;
...
ncwriteatt(NC_FILE,'river_time','units','days since 2000-01-01 00:00:00');  %%% ïœçXïKóv!!!!!!!!!!!!!!!!!!!!!!!!!!!
% river_transport
