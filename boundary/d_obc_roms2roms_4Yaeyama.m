...
NWAdata = '/work1/t2gnakamulab/ROMS/Yaeyama/Y1v13/Yaeyama1_his_150410_3.nc';
NWAgrid = '/work1/t2gnakamulab/ROMS/Yaeyama/Data/Yaeyama1_grd_v10.nc';

GRDname = '/work1/t2gnakamulab/ROMS/Yaeyama/Data/Yaeyama2_grd_v9.3.nc';
BRYname = '/work1/t2gnakamulab/ROMS/Yaeyama/Data/Yaeyama2_bry_Nz15_ROMS_150410_150930v13.nc';

StrDay = datenum('10-Apr-2015');        % starting day to process
EndDay = datenum('30-Sep-2015');        % ending   day to process
...
%  Set attributes for "bry_time".
  ...
  avalue='seconds since 2000-01-01 00:00:00';  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% !!!! check
...
%  Set global attribute.
  ...
  avalue='YAEYAMA2 Grid';
  [status]=nc_attadd(BRYname,'title',avalue);

  avalue='ROMS YAEYAMA application';
