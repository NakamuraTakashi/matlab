...
% riv_X_rho = [177, 181, 183, 185, 186, 188, 190, 192, 196, 199, 201, 182 ]; % Ncview
% riv_Y_rho = [144, 143, 139, 138, 137, 136, 135, 135, 135, 137, 139, 142 ]; % Ncview
...
ncwriteatt(NC_FILE,'river_time','units','days since 2000-01-01 00:00:00');
% river_transport
